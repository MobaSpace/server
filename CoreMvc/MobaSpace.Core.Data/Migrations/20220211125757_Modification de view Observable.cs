...
{
    public partial class ModificationdeviewObservable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("CREATE OR REPLACE FUNCTION Observable_encrypt_insert() RETURNS trigger" +
                                 ...
                                 " new_nonce," +
                                 " key_id)," +
                                 " \"Commentaire\" = crypto_secretbox(" +
                                 " convert_to(Cast(new.\"Commentaire\" As text), 'utf8')," +
                                 " new_nonce," +
                                 " key_id)," +
            ...
            migrationBuilder.Sql("CREATE OR REPLACE FUNCTION Observable_encrypt_update() RETURNS trigger" +
                                 ...
                                 " current_nonce," +
                                 " key_id))," +
                                 " \"Commentaire\" = COALESCE(crypto_secretbox(" +
                                 " convert_to(Cast(new.\"Commentaire\" As text), 'utf8')," +
                                 " current_nonce," +
                                 " key_id), crypto_secretbox(" +
                                 " convert_to(Cast(old.\"Commentaire\" As text), 'utf8')," +
                                 " current_nonce," +
                                 " key_id))," +
